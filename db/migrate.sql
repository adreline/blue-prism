...
START TRANSACTION;
USE `deeplinks`;
INSERT INTO `deeplinks`.`websites` (`title`, `contents`, `last_visited`, `url`, `banned`, `discovery_site`) VALUES (DEFAULT, DEFAULT, DEFAULT, 'http://jgwe5cjqdbyvudjqskaajbfibfewew4pndx52dye7ug3mt3jimmktkid.onion', DEFAULT, '__origin');
